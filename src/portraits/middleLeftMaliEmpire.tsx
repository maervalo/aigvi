...
export default function MiddleLeftMaliEmpire() {
    // Load models
    const portrait = useGLTF("./MiddleLeftMaliEmpire.glb");

    // Load the baked texture
    const bakedTexture = useTexture("/textures/MiddleLeftMaliEmpire.jpeg");
