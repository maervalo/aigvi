...
export default function MiddleLeftKimpaVita() {
    // Load models
    const portrait = useGLTF("./MiddleLeftKimpaVita.glb");

    // Load the baked texture
    const bakedTexture = useTexture("/textures/MiddleLeftKimpaVita.jpeg");
