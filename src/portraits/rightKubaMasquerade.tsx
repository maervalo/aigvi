...
export default function RightKubaMasquerade() {
    // Load models
    const portrait = useGLTF("./RightKubaMasquerade.glb");

    // Load the baked texture
    const bakedTexture = useTexture("/textures/rightKubaMasquerade.jpg");
