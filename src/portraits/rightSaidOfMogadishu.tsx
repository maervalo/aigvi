...
export default function RightSaidOfMogadishu() {
    // Load models
    const portrait = useGLTF("./RightSaidOfMogadishu.glb");

    // Load the baked texture
    const bakedTexture = useTexture("/textures/rightSaidOfMogadishu.jpeg");
