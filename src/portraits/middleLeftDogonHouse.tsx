...
export default function MiddleLeftDogonHouse() {
    // Load models
    const portrait = useGLTF("./MiddleLeftDogonHouse.glb");

    // Load the baked texture
    const bakedTexture = useTexture("/textures/MiddleLeftDogonHouse.jpeg");
