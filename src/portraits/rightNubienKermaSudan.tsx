...
export default function RightNubienKermaSudan() {
    // Load models
    const portrait = useGLTF("./RightNubienKermaSudan.glb");

    // Load the baked texture
    const bakedTexture = useTexture("/textures/rightNubienKermaSudan.jpeg");
