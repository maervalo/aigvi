...
export default function RightDonFransciscoDeArobe() {
    // Load models
    const portrait = useGLTF("./RightDonFranscisoDeArobe.glb");

    // Load the baked texture
    const bakedTexture = useTexture("/textures/rightDonFranscisoDeArobe.jpg");
