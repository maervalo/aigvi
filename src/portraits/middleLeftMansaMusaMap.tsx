...
export default function MiddleLeftMansaMusaMap() {
    // Load models
    const portrait = useGLTF("./MiddleLeftMansaMusaMap.glb");

    // Load the baked texture
    const bakedTexture = useTexture("/textures/MiddleLeftMansaMusaMap.jpeg");
